    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MyUserDbContext>(
                opt => opt.UseSqlServer("Data Source=localhost;Initial Catalog=IdentityCurso;User id=sa;Password=123456;Integrated Security=SSPI;", sql => sql.MigrationsAssembly(migrationAssembly))
                );
